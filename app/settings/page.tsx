                    ...
                    <form onSubmit={handleSetPassword} className="space-y-4">
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full bg-[#0f0f0f] border border-gray-700 rounded-lg px-4 py-3 pr-12 focus:border-cyan-500 focus:outline-none transition"
                                    required
                                />
                                <button
                                    type="button"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-[#0f0f0f] border border-gray-700 rounded-lg px-4 py-3 focus:border-cyan-500 focus:outline-none transition"
                                required
                            />
                        </div>
